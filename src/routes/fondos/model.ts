...
export const FondoSchema = t.Object({
  ...
  inicio: t.Optional(t.Union([t.Date(), t.String({ format: 'date' }), t.Null()])),
  cierre: t.Optional(t.Union([t.Date(), t.String({ format: 'date' }), t.Null()])),
...
export const FondoModel = {
  ...
  async update(
    ...
    const updateData = {
      ...
      financiamiento: fondoData.financiamiento === undefined ? undefined : fondoData.financiamiento,
      plazo: fondoData.plazo === undefined ? undefined : fondoData.plazo,
      objetivo: fondoData.objetivo === undefined ? undefined : fondoData.objetivo,
